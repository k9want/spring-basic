...
public class FruitBoxEx4 {
    public static void main(String[] args) {
        ...
        appleBox.add(new Apple4("Apple1", 300));
        appleBox.add(new Apple4("Apple2", 100));
        appleBox.add(new Apple4("Apple3", 200));

        grapeBox.add(new Grape4("grape1", 300));
        grapeBox.add(new Grape4("grape2", 200));
        grapeBox.add(new Grape4("grape3", 100));
